...
%% @doc Returns the size of the fifo, the length of both lists.
...
%% @doc Adds a new value to the fifo.
...
%% @doc Pops the first value of the fifo.
%% @throws 'empty fifo'
%% TODO: add a -spec type declaration
...
%% @doc Returns true/false if the fifo is empty or not.
